...
def save_plugin_config():
    ...
    try:
        ...
        # 保存到插件配置
        config_instance.set_plugin_config('manual_grouping', config_data)
        return True
...
def load_plugin_config():
    ...
    try:
        ...
        # 从插件配置中加载
        config_data = config_instance.get_plugin_config('manual_grouping', {})
...
def clear_plugin_config() -> bool:
    ...
    try:
        from ..config import Config
        config_instance = Config()
        config_instance.remove_plugin_config('manual_grouping')
